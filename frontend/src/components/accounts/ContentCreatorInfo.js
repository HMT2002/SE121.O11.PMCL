    ...
    <React.Fragment>
      <div style={{ paddingInline: '12rem' }}>
        <div style={{ marginBlockEnd: '2rem' }}>
          ...
          {props.context.role !== 'content-creator' && (
            <div className="account-page__details__row">
              <Input
          ...
          {isRequestSuccess != null && (
            <div
              className={
                isRequestSuccess ? 'account-page__request-message__success' : 'account-page__request-message__failed'
              }
            >
              {requestMessage}
            </div>
          ...
          <div className="account-page__details__row" style={{ justifyContent: 'flex-end' }}>
            {props.context.role !== 'content-creator' && !isRequestSuccess && (
              <Button
